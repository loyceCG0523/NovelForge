...
def sanitize_preferences(preferences: dict) -> dict:
    ...
    if api_key:
        ...
        llm["api_key_masked"] = mask_api_key(api_key)
    ...
    if review_api_key:
        ...
        review_llm["api_key_masked"] = mask_api_key(review_api_key)
    ...
    if embedding_api_key:
        ...
        embedding["api_key_masked"] = mask_api_key(embedding_api_key)
    ...
    if tavily_api_key:
        ...
        web_search["tavily_api_key_masked"] = mask_api_key(tavily_api_key)
